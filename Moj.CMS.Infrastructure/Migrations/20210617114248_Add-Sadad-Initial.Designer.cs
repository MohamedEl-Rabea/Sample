...
namespace Moj.CMS.Infrastructure.Migrations
{
    ...
    [Migration("20210617114248_Add-Sadad-Initial")]
    partial class AddSadadInitial
    {
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Aggregates.Case.Case", b =>
                {
                    ...
                    b.OwnsMany("BlazorHero.CleanArchitecture.Domain.Aggregates.Case.Entities.CaseSadad", "SadadList", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                            ...
                            b1.Property<decimal>("RequiredAmount")
                                .HasColumnType("decimal(18,2)");

                            b1.Property<string>("SadadNumber")
                                .IsRequired()
                                .HasMaxLength(256)
                                .HasColumnType("nvarchar(256)");
