...
namespace Moj.CMS.Infrastructure.Migrations
{
    ...
    [Migration("20210609154109_AddCaseVIban")]
    partial class AddCaseVIban
    {
            ...
            modelBuilder.Entity("BlazorHero.CleanArchitecture.Domain.Aggregates.Case.Case", b =>
                {
                    ...
                    b.OwnsOne("BlazorHero.CleanArchitecture.Domain.Aggregates.Case.Entities.CaseVIban", "VIban", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
